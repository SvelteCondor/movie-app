import {
  ...
  export const fetchMovies = async (movies, loadMore, searchTerm) => {
    ...
    //retour si loadMore on ajoute le résultat au array movies
    return {
      ...movies,
      movies: loadMore
        ? [...movies.movies, ...result.results]
        : [...result.results],
      heroImage: movies.heroImage || result.results[0], //récupére image home si n'existe pas je prend le premier film
